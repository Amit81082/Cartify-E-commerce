...
const ProductDetails = () => {
  ...
  const { fetchCountAddtoCart } = useContext(Context);
  ...
  const fetchProductDetails = async () => {
    ...
    console.log("product details data", dataReponse?.data);
                  ...
                  return (
                    ...
                    >
                      <img
                        ...
                        onMouseEnter={() => handleMouseEnterProduct(img?.url)}
                        onClick={() => handleMouseEnterProduct(img?.url)}
                      />
                    </div>
                  );
                })}
